package com.sudhakar.openweather.weather.service;
...
import static com.sudhakar.openweather.weather.view.WeatherActivity.mCitySearch;
import static com.sudhakar.openweather.weather.view.WeatherActivity.mWeather;
...
public class CurrentWeatherService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            URL url = Utils.getWeatherForecastUrl(Constants.WEATHER_ENDPOINT, latitude, longitude, units, Locale.getDefault().getLanguage());
